...
<?php
$id_codigo = $_POST['codigo']; //obtém a linha, o id no bd
...
<div class="container">
  <?php if($matricula > 0){?>
    <?php if ($tela > 767) { ?>
      <div id="texto2">Abaixo se encontra o formulário com dados para alteração</div> 
  <?php } ?> 
    ...
    <div class="card mb-3" id="moldura">
      ...
      <form id="formulario" method="post" action="actions1.php" name="formulario">
        <div id="form">
          <input type="hidden" id="id_acao" name="acao" /> <!-- Controle "Escondido" -->
          <input type="hidden" id="id_identificacao" name="identificacao" value="<?php echo $id_codigo; ?>" /> <!-- Controle "Escondido" -->

          <div class="form-row">
            <div class="form-group col-md-6">
              <label><b>Nome:</b></label>
              <input type="text" name="nome" id="id_nome" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" required value="<?php echo $nome; ?>" /><br />
            </div>
            <div class="form-group col-md-6">
              <label><b>Sobrenome:</b></label>
              <input type="text" name="sobrenome" id="id_sobrenome" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" required value="<?php echo $sobrenome; ?>" /><br />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label><b>Email:</b></label>
              <input type="text" name="email" id="id_email" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" required value="<?php echo $email; ?>" /><br />
            </div>
            <div class="form-group col-md-6">
              <label><b>Matricula:</b></label>
              <input type="text" name="matricula" id="id_matricula" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" required value="<?php echo $matricula; ?>" /><br />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label><b>Senha:</b></label>
              <input type="text" name="senha" id="id_senha" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" required value="<?php echo $senha; ?>" /><br />
            </div>
            <div class="form-group col-md-6">
              <label><b>Usuário:</b></label>
              <input type="text" name="username" id="id_username" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" required value="<?php echo $username; ?>" /><br />
            </div>
          </div>
...
<?php }else{?>
  <div id="texto2">Código não encontrado!</div>
<?php }?>
