			...
			<div class="card-body"><?php } ?>
				<div id="matric" >
					<form id="formulario" method="post" action="actions3.php" name="formulario">
						...
						<input type="text" name="matricula" id="id_matricula" autofocus required class="form-control justify-content-center" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B; " /><br /><br><br />

						<input type="button" value="Excluir" class="btn btn-primary justify-content-center" onclick="executaPost('formulario','excluir');" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 80px; height: 40px;" />
