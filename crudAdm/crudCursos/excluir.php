...
<body style="background-size: 100%; ">
	...
	<div class="container">
        ...
        <?php } ?>           
			...
			<div id="matric" >
				<form id="formulario" method="post" action="actions3.php" name="formulario">
					<input type="hidden" id="id_acao" name="acao" /> <!-- Controle "Escondido" -->
					<label ><b>Nome (denominação):</b></label>
					<input type="text" name="nome" id="id_nome" autofocus required class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br /><br><br />
					<input type="button" value="Excluir" class="btn btn-primary" onclick="executaPost('formulario','excluir');" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 80px; height: 40px;" />
          <p><a style='font-size:16px; color: #008B8B' text-align='center' href="formulario.php"><br><b>VOLTAR</b></a></p>
				</form>
			</div>
