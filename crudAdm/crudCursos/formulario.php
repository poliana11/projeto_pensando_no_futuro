...
<body style="background-size: 100%; ">
    ...
    <form>
        <div id="botoes">
            <input type="button" value="Inserir novo curso" onclick="javascript: location.href='incluir.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
            </br></br>
            <input type="button" value="Alterar dados cursos" onclick="javascript: location.href='escolher.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
            </br></br>
            <input type="button" value="Excluir curso" onclick="javascript: location.href='excluir.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
            </br></br>
