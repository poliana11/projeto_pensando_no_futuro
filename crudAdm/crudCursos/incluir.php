...
<body style="background-size: 100%; ">
	...
	<?php if ($tela > 767) { ?>
		<div id="texto2"> Cadastro abaixo</div>
    <?php } ?>  
	...
	<div class="container">
	<form id="formulario" method="post" action="actions2.php" name="formulario" enctype="multipart/form-data">
				...
				<div style="position: absolute; color: #424242; justify-content: center;" id="margem">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="text" name="nome" id="id_nome" class="form-control" style="border-color: #008B8B; " /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-4">
							<label><b>Forma de oferta:</b></label>
							<input type="text" name="oferta" id="id_oferta" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-4">
							<label><b>Modalidade (presencial ou à distância):</b></label>
							<input type="text" name="modalidade" id="id_modalidade" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-4">
							<label><b>Habilitação:</b></label>
							<input type="text" name="habilitacao" id="id_habilitacao" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Local da oferta:</b></label>
							<input type="text" name="localizacao" id="id_local" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-6">
							<label><b>Eixo tecnológico:</b></label>
							<input type="text" name="eixoTec" id="id_eixoTec" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-4">
							<label><b>Turno:</b></label>
							<input type="text" name="turno" id="id_turno" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-4">
							<label><b>Número de vagas:</b></label>
							<input type="text" name="vagas" id="id_vagas" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-4">
							<label><b>Período:</b></label>
							<input type="text" name="periodo" id="id_periodo" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-4">
							<label><b>Carga horária total:</b></label>
							<input type="text" name="horas" id="id_horas" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-4">
							<label><b>Tempo de integralização:</b></label>
							<input type="text" name="integralizacao" id="id_lintegralizacao" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-4">
							<label><b>Tempo máximo de integralização:</b></label>
							<input type="text" name="integralizacaoMax" id="id_integralizacaoMax" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Contato da Direção de Ensino:</b></label>
							<input type="text" name="diretorEns" id="id_diretorEns" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-6">
							<label><b>Contato da coordenação do curso:</b></label>
							<input type="text" name="coordenador" id="id_coordenador" class="form-control" style="border-color: #008B8B;" /><br />
						</div>
					</div>
					<div>
						<div class="form-group">
							<label><b>Justificativa:</b></label>
							<textarea type="text" name="justificativa" maxlength=2200 id="id_justificativa" class="form-control" style="border-color: #008B8B;" rows="10"></textarea>
						</div>
					</div>
					<div>
						<div class="form-group">
							<label><b>Objetivo Geral:</b></label>
							<textarea type="text" name="objetivoG" id="id_objetivoG" class="form-control" style="border-color: #008B8B;" rows="10"></textarea>
						</div>
					</div>
					<div>
						<div class="form-group">
							<label><b>Objetivo Específico:</b></label>
							<textarea type="text" name="objetivoE" id="id_objetivoE" class="form-control" style="border-color: #008B8B;" rows="10"></textarea><br />
						</div>
					</div>
					<div>
						<div class="form-group">
							<label><b>Competências:</b></label>
							<textarea type="text" name="competencias" id="id_competencias" class="form-control" style="border-color: #008B8B;" rows="10"></textarea><br />
						</div>
					</div>
					<div>
						<div class="form-group">
							<label><b>Área de atuação:</b></label>
							<textarea type="text" name="atuacao" id="id_atuacao" class="form-control" style="border-color: #008B8B;" rows="10"></textarea><br />
						</div>
					</div>
					<div>
						<div class="form-group">
							<label><b>Infraestrutura:</b></label>
							<textarea type="text" name="infraestrutura" id="id_infraestrutura" class="form-control" style="border-color: #008B8B;" rows="10"></textarea><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Matriz curricular (imagem da tabela):</b></label>
							<input type="file" name="matrizCurricular" class="form-control-file" style="border-color: #008B8B; color:#008B8B ; font-size: 17px; " /><br />
						</div>
						<div class="form-group col-md-6">
							<label><b>Imagem para link do curso:</b></label>
							<input type="file" name="imagem" class="form-control-file" style="border-color: #008B8B; color:#008B8B ; font-size: 17px; " /><br /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Arquivo PPC:</b></label>
							<input type="file" name="linkppc" class="form-control-file" style="border-color: #008B8B; color:#008B8B ; font-size: 17px; " /><br /><br />
						</div>
					</div>

					<input type="button" value="Salvar" class="btn btn-primary" onclick="executaPost('formulario','salvar');" id="botao_salvar"/>
          </br><p id="botao_voltar"><a href="formulario.php">VOLTAR</a></p>
        </div>
			</div>
		</div>
	</form>
