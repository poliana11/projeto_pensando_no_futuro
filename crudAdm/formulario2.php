...
<body style="background-size: 100%; ">
    ...
    <img src="images/logo8.png" id="logo" class="mg-fluid rounded float-right" style="position:absolute; top:60px;  max-height: 160px; max-width: 200px; right: 20px;" />
    ...
    <form>
        <div id="botoes">
            <input type="button" value="Alterar: Reitor(a) e Diretor(a)" onclick="javascript: location.href='alterarInst.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
            </br></br>
            <input type="button" value="Gerenciar administradores" onclick="javascript: location.href='formulario.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
            </br></br>
            <input type="button" value="Alterar informações no site" onclick="javascript: location.href='crudCursos/formulario.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
            </br></br>
            <p id="botao_voltar"><a style="font-size:16px; color: #008B8B" href="../administrador.php"><b>VOLTAR</b></a></p>
    </form>
    </div>
