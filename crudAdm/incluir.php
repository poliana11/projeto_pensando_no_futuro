...
<head>
	...
	<title>Criar conta do novo administrador</title>
	<!-- Optional JavaScript -->
...
<body style="background-size: 100%; ">
	...
	<img src="images/logo8.png" id="logo" class="mg-fluid rounded float-right" style="position:absolute; top:55px;  max-height: 160px; max-width: 200px; right: 20px;" />
    <div id="texto"><b>Cadastrar novo administrador</b></div>

	<?php $tela= $_SESSION['screenInfo']['heightTela']; 
		    //$tela = 500; ?>
	<?php if ($tela > 767) { ?><div id="texto2">Cadastro abaixo</div> <?php }?>
  ...
  <?php if ($tela <= 767) { ?>
	...
	<form id="formulario" method="post" action="actions2.php" name="formulario" enctype="multipart/form-data">
		<div class="card mb-3" id="moldura" style="background-color: white; border-color: teal; margin-top: 3em;">
			<div class="card-body">
				<?php if ($tela <= 767) { ?><div id="texto2">Cadastro abaixo:</div> </br></br><?php }?> 
				<div id="cads">
					<input type="hidden" id="id_acao" name="acao" /> <!-- Controle "Escondido" -->
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Nome:</b></label>
							<input type="text" name="nome" id="id_nome" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-6">
							<label><b>Sobrenome:</b></label>
							<input type="text" name="sobrenome" id="id_sobrenome" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Email:</b></label>
							<input type="text" name="email" id="id_email" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-6">
							<label><b>Matricula:</b></label>
							<input type="text" name="matricula" id="id_matricula" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br />
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label><b>Senha:</b></label>
							<input type="text" name="senha" id="id_senha" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br />
						</div>
						<div class="form-group col-md-6">
							<label><b>Usuário:</b></label>
							<input type="text" name="username" id="id_username" class="form-control" style="background-color: rgba(23, 199, 230, 0.123); border-color: #008B8B;" /><br />
						</div>
					</div>
					<input type="button" value="Salvar" class="btn btn-primary" onclick="executaPost('formulario','salvar');" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 80px; height: 40px;" />
				</div>
			</div>
		</div>
	</form>
