...
<body style="background-size: 100%; ">
    ...
    <div class="container">
        <div id="botoes">
            <form>
                <input type="button" value="Cadastrar novo administrador" onclick="javascript: location.href='incluir.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
                </br></br>
                <input type="button" value="Alterar dados administradores" onclick="javascript: location.href='escolher.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
                </br></br>
                <input type="button" value="Excluir administrador" onclick="javascript: location.href='excluir.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
                </br></br>
                <input type="button" value="Consultar administradores" onclick="javascript: location.href='consultar.php';" class="btn btn-primary" style="border-color: #008B8B; background-color: #008B8B; font-size: 15px; width: 225px; height: 40px;" />
                </br></br>
                <p id="botao_voltar"><a style="font-size:16px; color: #008B8B" href="formulario2.php"><b>VOLTAR</b></a></p>
            </form>
        </div>
    </div>
